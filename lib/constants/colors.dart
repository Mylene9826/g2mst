...
class AppColors {
  static final MaterialColor mainColor = const MaterialColor(
    0XFFF50057,
    const <int, Color>{
      50: const Color(0XFFF50057),
      100: const Color(0XFFF50057),
      200: const Color(0XFFF50057),
      300: const Color(0XFFF50057),
      400: const Color(0XFFF50057),
      500: const Color(0XFFF50057),
      600: const Color(0XFFF50057),
      700: const Color(0XFFF50057),
      800: const Color(0XFFF50057),
      900: const Color(0XFFF50057),
    },
  );
  //static const PrimaryColor = Color(0xFF0C4B8D);
  static const primaryColor = Color(0XFFF50057);
  static const Color yellow = Color(0XFFF50057);
